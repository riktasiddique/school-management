...
<body>
    ...
    <section class="hero_section ">
      <div class="hero-container container">
        ...
        <div class="hero_img-container">
          <div>
            <img src="{{asset('front-end/images/hero.png')}}" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
  ...
  {{-- <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="about_img-box ">
        <img src="{{asset('front-end/images/kids.jpg')}}" alt="" class="img-fluid w-100">
      </div>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="vehicle_img-box ">
                <img src="{{asset('front-end/images/bus.png')}}" alt="" class="img-fluid w-100">
              </div>
            </div>
        ...
        <div class="client_container d-flex flex-column">
          <div class="client_detail d-flex align-items-center">
            <div class="client_img-box ">
              <img src="{{asset('front-end/images/student.png')}}" alt="">
            </div>
        ...
        <div class="container">
          <div class="admission_container position-absolute">
            <div class="admission_img-box">
              <img src="{{asset('front-end/images/kidss.jpg')}}" alt="">
            </div>
  ...
  {{-- @include('layouts.navber.frontt.footer') --}}
  ...
  <script>
    ...
    function initMap() {
      ...
      var image = 'front-end/images/maps-and-flags.png';
